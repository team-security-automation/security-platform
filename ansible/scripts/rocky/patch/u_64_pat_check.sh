...
# ============================================================
PENDING=$(dnf check-update 2>/dev/null | grep -cE '^[^[:space:]]+\.(x86_64|noarch|i686)')
AUTO="비활성"
systemctl is-active --quiet dnf-automatic.timer 2>/dev/null && AUTO="활성"
